        ...
        <div class="p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.sales') }}?filter=daily" class="px-4 py-2 rounded-lg font-semibold transition text-white {{ $filter === 'daily' ? 'bg-red-600' : 'bg-gray-200 text-gray-800' }}">
                        Daily
                    </a>
