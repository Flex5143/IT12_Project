                        ...
                        <div class="space-y-3 mb-6">
                            @foreach($order->orderItems as $item)
                                <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                    <div>
                                        <p class="font-semibold" style="color: #1f2937;">{{ $item->menuItem->name }}</p>
                                        <p class="text-sm text-gray-600">{{ $item->menuItem->category }}</p>
                                    </div>
                                    <span class="text-2xl font-bold" style="color: #dc2626;">×{{ $item->quantity }}</span>
                                </div>
                            @endforeach
                        </div>
